 ...
 */
abstract class AbsClass1 {////////////////////////////////////////////////////////////////////////AbsClass1
	//int형으로 표현할수 있는 최대값을 반환하는 Wrapper클래서 
	public static final int MAX_INT = Integer.MAX_VALUE;//기본자료형 객체로변경?
...
class AbsClassChild1 extends AbsClass1{/////////////////////////////////////////////////////AbsClassChild1
 ...
 */
abstract class absClass2 {////////////////////////////////////////////////////////////////////////////absClass2
 ...
 */
class absClassChild2 extends absClass2 {////////////////////////////////////////////////////////absClassChild2
	@Override //오버라이딩 해야지만 에러가 발생하지않음.
...
public class E01AbstractBasic {////////////////////////////////////////////////////////////////////E01AbstractBasic main
	...
	public static void main(String[] args) {
		...
		((absClassChild2)absClass2).newMethod();/*
			부모타입의 참조변수로 자식객쳉에 접근하려면
			다운캐스팅(강저형변환) 후 접근이 가능하다.
