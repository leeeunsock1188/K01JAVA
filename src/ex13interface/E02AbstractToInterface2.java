...
/*
클래스가 클래스를 상속받을떄 => extends 사용
클래스가 인터페이스를 상속받을때 => implements 사용
인터페이스가 인터페이스를 상속받을떄 => extends사용 

extends는 '상속' 이라 표현하고, implements는 '구현'이라 표현한다.
 
 */
class PersonalNumberStorageImpl implements PersonalNumberStoratsInter {///////////
	//멤버변수 
...
public class E02AbstractToInterface2 {
	...
	public static void main(String[] args) {
		...
		PersonalNumberStoratsInter storage = 
