...
set계열의 컬렉션은 기본적으로 중복저장을 허용하지 않는다. 그러나 아래와 같이 새롭게 정의한 클래스에
 대해서는 equals(), hashCode() 메소드를 적절히 오버라이딩 처리해야 중복을 제거할 수 있다.
...
class Avengers {
	...
	@Override
	public int hashCode() { // 이유: 기능 ... 객체가가지고있는 고유 숫자형태로 표현해준다 
	
		//객체가 가진 고유한값(참조값)을 int형으로 반환하는 메소드 
		int hc1 = name.hashCode(); // 자동완성을 사용해도된다.  
		int hc2 = heroName.hashCode();
		int hc3 = weapon.hashCode();
		System.out.println(hc1+ " "+hc2 +" "+ hc3);/*
		-566707416 1555130848 1449062364
		431106056 -1841222965 -1522474641
		-853886304 1750172 788952015
		-566707416 1555130848 1449062364
		반환됨.
		*/
