...
public class E01AccessModifierMain {
	...
	public static void main(String[] args) {
		...
		one.publicMethod();
		/*
		 동일한 패키지에 선언된 클래스 이므로 import없이 객체생성 및 
		 접근이 가능하다. 
		 */
		System.out.println("DefaultClass 객체에 생성 및 접근");
		...
		//System.out.println("two.defaulVar ="+ two.defaultVar);
		...
		/*
		 ...
		 import도 불가능 하므로 아예 사용할수 없는 클래스이다.
		 */
