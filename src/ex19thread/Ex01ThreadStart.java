...
/*
 ...
 -해당 방법은 쓰레드로 생성할 클래스가 다른 크래스를 상속받지 않아도
 될떄 사용하는 방식이다,
 -만약 다른 클래스를 상속받아야 한다면JAVA는 다중상속이 불가능하므로
		 ...
		 for (int i =1; i <= 100; i++) {
			...
			try {
				/*
				 ...
				 1000이 1초 이므로 아래는 0.01초만큼 Block시킨다.
				 */
				sleep(10);
			} catch (Exception e) {
				e.printStackTrace();
