...
자바의정석
 	...
 	해당 쓰레드를 실행하게 되면  main 메소드가 종료된 이후에도
 	실행되는것을 볼수있다.
 */
class YesThread extends Thread///////////////////////////////////////질문하기 
{
	public YesThread() 	{}
	/*
	 Thread클래스의 생성자를 호출할때 전달되는 매개변수를
	...
	void threadMethod() throws InterruptedException {
		for (int i = 1; i <=10; i++) {
			...
			sleep(2000);//2초의 한번씩 Block상태가 된다.
		}
	}
	@Override
	public void run() {
...
/*
 종속쓰레드 (Daemon Thread) 
 	...
 	구성된다. setDaemon(true) 메소드로 설정할수 있다.
 */
...
public class Ex03DaemonThread {
	...
	public static void main(String[] args) {
		...
		yt1.setName("첫번째 쓰레드");//쓰레드의 이름지정 두번쨰 방법 
		...
		*/
		...
		System.out.println("현재 활성화된상태의 쓰레드수 "+
				Thread.activeCount());
