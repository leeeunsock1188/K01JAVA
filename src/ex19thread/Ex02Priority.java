...
/*
 쓰레드의 우선순위
 	...
 	getpriority() :쓰레드의 우선순위를 반환할떄 사용 
 */
...
//		 MessageSendingThread tr3 = new MessageSendingThread("세번째");
		...
		/*
		 2단계
		 	:우선순위 여부를 위해 Thread클래스에 static 타입의
		 	상수를 이용한다.
		...
		MessageSendingThread tr2 = new MessageSendingThread ("듀번째", Thread.NORM_PRIORITY);
