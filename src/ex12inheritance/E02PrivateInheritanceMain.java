...
class Account {
	 ...
	 */
	protected void depositMoney(int _money) { //하위에서 접근가능
		if(_money<0) {
	...
	//private멤버변수를 외부클래스로 반환할떄 사용함 
	protected int getAccMoney() { // get역활 
		return money;
	}
