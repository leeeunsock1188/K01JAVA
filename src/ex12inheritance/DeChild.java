...
public class DeChild extends DeParent {
	...
	/*
	 오버라이딩 아님. 
	 부모클래스에서 private멤버메소드로 선언되었기 떄문에 자식에서는 
	 보이지 않으므로 오버라이딩의 대상이 될수 없다. 
	 */
	private void eat() {
	...
	/*
	메소드 오버라이딩의 조건
	-부모클래스에서 선언될떄와 비교해서 접근범위가
	동일하거나 그보다 넓으면 가능하다.
	-즉 부모에서 default일떄 자식쪽에서 default 
	public이면 오버라이딩 가능하다. 
	 */
	...
	/*
	 ...
	 super.멤버 : 부모클래스에 정의된 멤버변수 혹은 멤버 메소드를
	 	호출할때 사용 
	 */
	...
	/*
	 ...
	 대상이 될수 없다. 
	 */
	// static은 method 영역에 존재해서 오버라이딩 안됌 
	public static void staticMethod() {
		System.out.println("학생의 정적메드");
	}
}
