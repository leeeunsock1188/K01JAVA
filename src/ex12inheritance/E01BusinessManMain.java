package ex12inheritance;
	...
	/*
	 상속 (Inheritance)
	 	...
	 	클래스를 정의하는것을 말한다.
	 	부모클래스를 자식클래스가 상속할떄는 extends 키워드를 
	 	사용한다. 
	 */
...
//자식클래스(하위,유도,Sub) :Man 클래스를 상속받는 회사원 클래스 
	class BusineeMan extends Man {
		 ...
		 */
		public BusineeMan(String name, String company, String position) {
...
public class E01BusinessManMain {
	...
	public static void main(String[] args) {
		BusineeMan man1= 
				new BusineeMan("김천국", "NAVER","팀장");
		BusineeMan man2= 
				new BusineeMan("이낙원", "DAUM","부장");
		
		man1.tellYourInfo();
		//man1.tellYourName(); //자식객체로 부모의 메소드 호출가
