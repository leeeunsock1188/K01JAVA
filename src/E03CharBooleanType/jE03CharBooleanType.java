package E03CharBooleanType;

public class jE03CharBooleanType {
	...
	public static void main(String[] args) {
		 ...
		 * */
		char ch1= '가';
		//char chStr = '가나다라';[에러발생] 문자열이므로 char 형변수에 대입불가
		String chStr = "가나다라";
		 ...
		 * 
		 */
		boolean bn3= bn1 && bn2;//AND 둘다 참 * 
		System.out.println("bn3(AND)="+bn3);
		bn3= bn1 || bn2; // OR 하나만 참이면 참 +
