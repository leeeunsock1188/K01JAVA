...
public class DBConnection {
	...
	String url = "jdbc:oracle:thim://@localhost:1521:orcl";
	String userid = "hr";
	String userpw = "123123";
...
public class DBConnection {
   ...
   public static void main(String[] args)
      ...
      /*
       2] 오라클에 연결하기 위한 커넥션URL, 계정 ID, 패스워드를 준비한다.
       		케넥션 URL => 
       			jdbc: oracle:thin://@IP주소:포트번호:SID
       		※서버 환경에 따라 ip주소, 포트번호, sid는 변경될수 없다.
       * */
