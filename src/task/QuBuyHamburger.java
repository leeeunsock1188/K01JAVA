...
햄버거를 추상화한 클래스와 기본가격, 세트가격을 추상화한 클래스를 정의하여 햄버거를 주문시 기본가격 혹은 
세트가격으로 출력할수 있도록 프로그램을 구현하시오. 
조건은 다음과 같다. 
햄버거
...
class HamburgerPrice {//////////////////////////////////////////////////////////////햄버거프라이스
	...
	//기본가격계산 : 햄버거의 price 는 private멤버이므로 getter를 통해 가져옴 //4500원반환
	public int price() {
...
//세트가격을 추상화(기본가격을 상속)
class SetPrice extends HamburgerPrice {	/////////////////////////////////////////////////////////////셋프라이스
	//인자생성자
...
public class QuBuyHamburger {/////////////////////////////////////////////////////////////햄버거
