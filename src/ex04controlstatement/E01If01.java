...
import java.io.IOException; //예외 처
...
/*
	...
	*/
	 ...
	 */
		...
		/*
		조건검사후 실행할 문장이 하나인 경우에는 {} 중괄호를 생략할수 있다. 단, 
		실행문이 2개이상인 경우 에는 한문장만 싱행되므로 주의해야 한다. 		 
		*/
		if(num%2 ==0 )
			System.out.println("\n"+ num + "입니다.");
	...
	이를 무시하기 위해 main()함수에서throws처리를 해준다.
	 * */	
//	System.out.print("하나의 문자를 입력하세요:");
//	int asciiCode= System.in.read();
//	System.out.println("인력한문자:"+ asciiCode);
...
//	
	...
	/*
 	...
 	※ 숫자의 구간을 정할떄는 반드시 논리 AND를 사용해야 한다. 
	 */
