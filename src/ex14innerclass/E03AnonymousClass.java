...
public class E03AnonymousClass {
	...
	public static void main(String[] args) {
		/*
		 ...
		 부모클래스의 참조변수로 참조함.
		 참조변수가 부모타입이므로 자식객체에 직접 접근하는것을 불가능.
		 반드시 다운캐스팅 후 접근해야한다.
		 */
		...
		Person anonyPerson = new Person("이말년") {
			...
			void printInfo() {
				...
				newMethod(); System.out.println("익명클래스에서 오버라이딩");
			} 
		};
		...
		/*
		 ...
		 그러나 익명클래스는 클래스명이 없기 떄문에 위와같이 다운캐스팅이
		 불가능하다,
