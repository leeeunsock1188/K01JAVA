...
class Human{
	...
	public String toString() {
		String date = name + "\t" + age + "\t" + height + "\t"+ weight;
...
class StudentExam extends Human {
		String year;
	public StudentExam(String name, int age ,int height, int weight ,String year){
...
public class Prob02_ingeritance {
