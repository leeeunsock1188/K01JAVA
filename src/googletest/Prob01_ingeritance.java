...
//여기에 ClassTest_2클래스를 구현 
class ClassTest_2 extends ClassTest_1 {
	String department;
	
	
	public ClassTest_2(String name, int salary, String departments) {
		super(name, salary);
	...
	@Override
	public void getInformation() {
		System.out.println("이름:"+getNume()+ "연봉"+ super.getSalary() +"부서:"+ department);
	}
...
public class Prob01_ingeritance {
	
	public static void main(String[] args) {
		
		ClassTest_2 ct = new ClassTest_2("이자나",3000,"교육부");
		ct.callSuperThis();
		ct.getInformation();
