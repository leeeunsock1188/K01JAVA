...
class MyStatic{
	...
	/*
	 ...
	 (※main 메소드에서는 static으로 선언된 메소드만 호출할수
	 있었음을 기억하자)
	 */
...
public class E01StaticModifier {
	...
	public static void main(String[] args) {
		...
		System.out.println("myStaic.instanceVar="+ myStatic.instanceVar);
		/*
		 static(정적) 멤버변수 접근방법
		...
		System.out.println("myStaic.staticVar="+ myStatic.staticVar);
		/*
