...
class SingleTone {
	int shareVar;
	/*
	  JVM(자바 가상 머신)에 의해 프로그램이 시작될떄 정적변수는
	 ...
	 */
	public static SingleTone getInstance() {//SingleTone 타입으로 반환 
		return single;
	}
	void print() {
...
public class E03SingleToneDesignPattern {
	...
	public static void main(String[] args) {
		...
		SingleTone st2 = SingleTone.getInstance(); // static 으로 선언된 변수나 메소드 는 이름모양이 바뀜 
		st2.shareVar =100;
		st2.print();
