...
class AgeErrirExceotuib extends Exception{
	public AgeErrirExceotuib() {
...
public class Ex06DeveloperDefine {
	...
	public static int readAge() throws AgeErrirExceotuib {
		...
		if(inputAge <0) {
			AgeErrirExceotuib ex = new AgeErrirExceotuib();
			throw ex;
			}
	 return inputAge;
	}
