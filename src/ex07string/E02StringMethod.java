...
public class E02StringMethod {
	...
	public static void main(String[] args) {
		...
		/*
		 * compareTo() : 두 문자열을 첫번쨰 문자부터 순차적으로 
		  	비교하면서 
		 		앞의 문자열의 아스키코드가 크면 양수를 반환
		 		뒤에 문자열의 아스키코드가 크면 음수를 반환
		 		같으면 0을 반환한다. 
		 */
		String str3= "A";
		String str4= "B";
		...
		/*
		 5] concat() : 두개의 문자열을 연결할떄 사용한다.  +기호와
		 동일한 역할을 한다. 
		 */
	...
	/*
	 ...
	 not@naver => 이메일 형식이아님
	 	 */
			...
			System.out.println(str1.indexOf("J")); // -1 해당 글자가 없으면  -1 반환 index는 0부터 시작이니까
			System.out.println((email1.indexOf("@")!=-1)?
					...
					/*
					 13] split() 
					 		...
					 		배열로 반환한다. 
					 */
					String phoneNumber = "010-1234-5678";//배열형태로 만들어짐
					String[] phoneArr = phoneNumber.split("-");//구분자가없으면 그냥 
					//index가 1인 형태의 배열로 반환된다.
