...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 - 일반적으로 CPU(중앙처리장치)는 정수형 연산을 할떄  int 형을 가장 빠르게 처리한다.
		 -즉 정수형 변수는 대부분 int 형을 사용한다.	  
		 * */
		int int1 =100; 
		int int2 = 200;
		int result1= int1 + int2;
		System.out.println("int2+int2= "+result1); // 결과 : 300
		
	
		result1 = int1 / int2;// 두개의 정수를 나눳거 몫을 변환한다. 
		System.out.println("int1 / int2 "+ result1);// 결과: 0
		/*
		 * int 보다 작은 자료형을 연산하면 컴파일러는  int형으로 변환하여 연산한다.
		 * byte, short 형은 게임캐릭터의 움직임의 표현이나 음원정보등을 저장할떄 사용한다.  
		 * */
		...
		long result4 = int1+long1;//int +long = long형으로 변환 (자동형변환) 자료손실이 안남 
		...
		/*
		 * 자바컴파일러(cpu)는 정수형상수를 기본적으로 int 형으로 간주하기떄문에
