...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		/*
		 *  실수자료형
		 * 정수형보다는 실수형이 더 큰 자료형이다. (0과 1사이에 무수한 실수가 존재하기
		 * 때문)
		...
		long result2 = long1 +(long)float1;//명시적형변환 또는 강제형변환 (큰거에서 작은거로 변환 )자동으로 할수없고 수기로
//		변환해줘야함 자료에 손실이 생기기떄문에 
		...
		double d1= 3.14; // float + double = double(큰쪽으로 따라감) 
		double d2= f6 +d1;
