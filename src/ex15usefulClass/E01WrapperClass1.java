...
public class E01WrapperClass1 {
	...
	public static void main(String[] args) {
		...
		int  result3 = numObj1-numObj2; //객체끼리 뺄셈 연산  
		System.out.println("오토언박싱 이후 연산결과:"+ result3);
	
		/*
		 Wrapper클래스를 사용하는 이점
		 	:Wrapper클래스에 정의된 많은 메소드를 사용할수 있다.
		 	int형의 최대, 최대값 혹은 진법 변환등의 기능을 가지고 있다.
		...
		System.out.println("numObj.hashCode()="+ numObj.toString());
