...
public class E02WrapperClass1 {
	...
	public static void main(String[] args) {
		...
		/*
		문자열을 숫자로 변경할떄는 반드시 숫자형식만 와야한다.
		"원"은 숫자가 아니므로 NumberFormatException이 발생된다.
		 */
		
		String money = "120원"; // 런타임 에러 실행하고나면 에러가 발생 코드는 문제없는데 
...
//		System.out.println(Integer.parseInt(floatString));//[에러발생]
		...
		/*
		 실수형태의 문자열을 실수로 변경할떄는 parseInt()를 사용할수 없다. 
		 위와 똑같은 에러가 발생된다.
		 */
		...
		/*
		 4] isLetter() : 인자로 주어진 문자여부를 판단하는 메소드로 특수기호나 
		 	숫자형은 false를 반환한다.
		 */
